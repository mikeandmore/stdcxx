...
// * namespace-related macros (__STD, __SGI_STL_BEGIN_NAMESPACE, etc.)
...
#   define __SGI_STL_BEGIN_NAMESPACE namespace __gnu_cxx {
#   define __SGI_STL_END_NAMESPACE }
#   if defined(__STL_FUNCTION_TMPL_PARTIAL_ORDER) && \
       !defined(__STL_NO_RELOPS_NAMESPACE)
#     define __STL_USE_NAMESPACE_FOR_RELOPS
#     define __STL_BEGIN_RELOPS_NAMESPACE namespace std { namespace sgi { namespace rel_ops {
#     define __STL_END_RELOPS_NAMESPACE } } }
#     define __STD_RELOPS std::rel_ops
#   else /* Use std::rel_ops namespace */
#     define __STL_USE_NAMESPACE_FOR_RELOPS
#     define __STL_BEGIN_RELOPS_NAMESPACE namespace __gnu_cxx {
#     define __STL_END_RELOPS_NAMESPACE }
#     define __STD_RELOPS __gnu_cxx
#   endif /* Use std::rel_ops namespace */
# else
#   define __STD 
#   define __SGI_STL_BEGIN_NAMESPACE 
#   define __SGI_STL_END_NAMESPACE 

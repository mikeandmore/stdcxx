...
template <class _Val, class _Key, class _HashFcn,
          class _ExtractKey, class _EqualKey, class _Alloc = __STL_DEFAULT_ALLOCATOR(_Val)>
class hashtable;
...
private:
  typedef _Hashtable_node<_Val> _Node;
  typedef typename _Alloc::template rebind<_Node*> _Node_Alloc_Rebind;
  typedef typename _Node_Alloc_Rebind::other _Node_Alloc;

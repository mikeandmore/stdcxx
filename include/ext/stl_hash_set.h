...
template <class _Value, class _HashFcn, class _EqualKey, class _Alloc>
class insert_iterator<__STD::hash_set<_Value, _HashFcn, _EqualKey, _Alloc> > {
protected:
  typedef __STD::hash_set<_Value, _HashFcn, _EqualKey, _Alloc> _Container;
...
template <class _Value, class _HashFcn, class _EqualKey, class _Alloc>
class insert_iterator<__STD::hash_multiset<_Value, _HashFcn, _EqualKey, _Alloc> > {
protected:
  typedef __STD::hash_multiset<_Value, _HashFcn, _EqualKey, _Alloc> _Container;
  _Container* container;
